    ...
    for j,action in enumerate(actions):
        ...
        if x<=eps:
            ...
            for i in mchfora:
                ...
                mchsStartTimes,opIDsOnMchs,mchsEndTimes,temp1 = copy.deepcopy(env.ST_mchs[j]),copy.deepcopy(env.opesOnMchs[j]),copy.deepcopy(env.ET_mchs[j]),copy.deepcopy(env.CT_ope[j])
                ...
                LBs = calEndTimeLB(temp1, env.pt_ope_min[j], env.pt_ope_mean[j])
